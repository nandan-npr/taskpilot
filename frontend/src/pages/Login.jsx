        ...
        <div className="grid lg:grid-cols-[0.9fr_1.1fr] gap-10 items-center">
          <section className="hidden lg:block">
            ...
            <h1 className="font-display text-6xl leading-tight mt-4">
              Your tasks are waiting, neatly organized.
            </h1>

            <p className="text-[#6F675D] text-lg leading-8 mt-6 max-w-xl">
              Sign in to view your workflow board, track progress, and continue
              moving tasks from plan to completion.
            </p>
            ...
            <div className="mt-8 rounded-3xl border border-[#D8C9B3] bg-white p-6 max-w-md card-shadow">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-extrabold">Secure workspace</h3>
                  <p className="text-sm text-[#6F675D]">
                    Protected using token-based authentication.
                  </p>
                </div>
              </div>
            </div>
